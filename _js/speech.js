...
try{let speech_item = new SpeechSynthesisUtterance("本页有声");speechSynthesis.speak(speech_item)}catch{if(confirm("如果您想使用朗读功能，请下载firefox浏览器。\r\n安卓点击确认前往下载，苹果请到App Store。\r\n如果您不想使用朗读功能，请点取消。")){location.href="https://www.mozilla.org/zh-CN/firefox/browsers/mobile/get-app/"}}